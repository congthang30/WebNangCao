...
namespace NewWeb.Areas.NVKD.Pages.Orders
{
    ...
    public class ListOrderNewModel : PageModel
    {
        private readonly ApplicationDbContext _context;
        private readonly IEmailService _emailService;
        private readonly ILogger<ListOrderNewModel> _logger;

        public ListOrderNewModel(ApplicationDbContext context, IEmailService emailService, ILogger<ListOrderNewModel> logger)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                _logger.LogError(ex, "Error loading new orders");
